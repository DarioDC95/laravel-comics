    ...
    <section style="background-image: url({{Vite::asset('resources/img/images/footer-bg.jpg')}})" class="footer-links">
        <div class="mycontainer">
            <div class="myrow">
                ...
                <div class="mycol-lg">
                    <div class="mycard">
                        <img src="{{Vite::asset('resources/img/images/dc-logo-bg.png')}}" alt="Logo">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div>
                            <ul>
                                <li class="margin-right-xs">
                                    <a href="#">
                                        <img src="{{Vite::asset('resources/img/images/footer-facebook.png')}}" alt="Logo Facebook">
                                    </a>
                                </li>
                                <li class="margin-right-xs">
                                    <a href="#">
                                        <img src="{{Vite::asset('resources/img/images/footer-twitter.png')}}" alt="Logo Twitter">
                                    </a>
                                </li>
                                <li class="margin-right-xs">
                                    <a href="#">
                                        <img src="{{Vite::asset('resources/img/images/footer-youtube.png')}}" alt="Logo Youtube">
                                    </a>
                                </li>
                                <li class="margin-right-xs">
                                    <a href="#">
                                        <img src="{{Vite::asset('resources/img/images/footer-pinterest.png')}}" alt="Logo Pinterest">
                                    </a>
                                </li>
                                <li class="margin-right-xs">
                                    <a href="#">
                                        <img src="{{Vite::asset('resources/img/images/footer-periscope.png')}}" alt="Logo Periscope">
                                    </a>
                                </li>
                            </ul>
                        </div>
